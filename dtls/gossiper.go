...
import (
	...
	"fmt"
	"strings"
	"github.com/mdaigle/Peerster/dtls/protocol"
	"sync"
	"time"
...
// Defaults
const DEFAULT_HOP_LIMIT uint32 = 10
const DEFAULT_RTIMER int64 = 60
const DEFAULT_UI_PORT string = "10000"
const DEFAULT_NO_FORWARD bool = false
const DEFAULT_WEB_PORT string = "8080"
const DEFAULT_FILE_PATH string = "./hw3/_Downloads/"
const RESEND_TIMEOUT = 5
const SEARCH_RESEND_TIMEOUT = 1
...
func listenSetup() {
	for {
		...
		if err != nil ||
			final.MessageType != protocol.FINALX ||
			final.Data == nil {
			fmt.Println("Bad FINALX from", setup_listener_conn.RemoteAddr().String())
			setup_listener_conn = nil
			continue
		}
